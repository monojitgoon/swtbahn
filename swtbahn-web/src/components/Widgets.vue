...
<script>
    import Info from '../views/trackboard/InfoBox.vue';
    import InfoChart from '../views/trackboard/InfoBoxChart.vue';
    import InfoChartTwo from '../views/trackboard/InfoBoxChart2.vue';
